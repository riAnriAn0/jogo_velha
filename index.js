...
function result(jogador) {
  ...
  for (let i = 0; i < 3; i++) {
    if (
      matriz_tabulerio[i][0] === matriz_tabulerio[i][1] &&
      matriz_tabulerio[i][0] === matriz_tabulerio[i][2] &&
      (matriz_tabulerio[i][0] === "X" || matriz_tabulerio[i][0] === "O")
    ) {
      placar(jogador);
      return;
    }
  ...
  for (let i = 0; i < 3; i++) {
    if (
      matriz_tabulerio[0][i] === matriz_tabulerio[1][i] &&
      matriz_tabulerio[0][i] === matriz_tabulerio[2][i] &&
      (matriz_tabulerio[0][i] === "X" || matriz_tabulerio[0][i] === "O")
    ) {
      placar(jogador);
      return;
    }
  ...
  if (
    matriz_tabulerio[0][0] === matriz_tabulerio[1][1] &&
    matriz_tabulerio[0][0] === matriz_tabulerio[2][2] &&
    (matriz_tabulerio[0][0] === "X" || matriz_tabulerio[0][0] === "O")
  ) {
    placar(jogador);
    return;
  } else if (
    matriz_tabulerio[0][2] === matriz_tabulerio[1][1] &&
    matriz_tabulerio[0][2] === matriz_tabulerio[2][0] &&
    (matriz_tabulerio[0][2] === "X" || matriz_tabulerio[0][2] === "O")
  ) {
    placar(jogador);
    return;
  }
